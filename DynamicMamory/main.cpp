...
void main() {
...
#ifdef PUSH_FRONT
	cout << "¬ведите элемент: "; cin >> number;
	...
	int pos;
	//int num_2;
	cout << "¬ведите позицию элемента /1... 10/: "; cin >> pos;
	///cout << "¬ведите значение элемента: "; cin >> num_2;
...
#ifdef ERASE
	int index;
	cout << "¬ведите индех элемента: "; cin >> index;
	...
	//выдел€ем пам€ть под строки двумерного динамического массива
	...
	cout << "¬ведите позицию строки"; cin >> index_r;
...
#ifdef INSERT_COL
	cout << "¬ведите позицию столбца "; cin >> index_r;
